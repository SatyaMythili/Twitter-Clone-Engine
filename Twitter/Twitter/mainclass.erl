...
startTwitter()->
    ...
    register(hashTagMap,spawn(list_to_atom("centralserver@Mythili-HP"),sendreceive,hashTagTweetMap,[Map3])),
    register(subscribeToUser,spawn(list_to_atom("centralserver@Mythili-HP"),register,userSubscriberMap,[Map4,Map6])),
    register(userProcessIdMap,spawn(list_to_atom("centralserver@Mythili-HP"),register,userProcessIdMap,[Map5])).
sendTweet()->
